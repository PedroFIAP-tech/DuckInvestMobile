...
const userData = {
  name: 'Donald',
  actualBalance: '1.250,50', 
  maskedBalance: '******', // Saldo Oculto por padrão
  favorites: [
    { name: 'Visita ao Cofre', icon: 'safe-square-outline', color: COLORS.ACTION_GREEN },
    { name: 'Mapa da Riqueza', icon: 'map', color: COLORS.ACTION_GREEN },
    { name: 'Caça ao Tesouro', icon: 'finance', color: COLORS.ACTION_GREEN },
    // Adicionando mais itens para simular o conteúdo escondido
    { name: 'Missões', icon: 'school-outline', color: COLORS.ACTION_GREEN }, 
    { name: 'Relatórios', icon: 'chart-box-outline', color: COLORS.ACTION_GREEN },
  ],
  alerts: [
...
const GlobalHeader = () => (
    <View style={styles.globalHeaderContainer}>
        <View style={styles.globalHeaderIconPlaceholder}>
            <MaterialCommunityIcons name="account-tie" size={30} color={COLORS.PRIMARY_DARK} />
        </View>
...
const styles = StyleSheet.create({
  ...
  globalHeaderIconPlaceholder: { width: 40, height: 40, borderRadius: 8, backgroundColor: COLORS.HIGHLIGHT_GOLD, justifyContent: 'center', alignItems: 'center', },
